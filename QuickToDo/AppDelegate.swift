...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        dataManager.getAllItemsFromCloud({ x in print("Number of items from cloud: \(x.keys.count)") })
        
        return true
    }
    
    func showAlertInvitationOnMainViewController(_ record: CKRecord) {
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any]) {
        ...
        if (notification.notificationType ==
            CKNotificationType.query) {
                ...
                //viewController.itemsTable.reloadData()
